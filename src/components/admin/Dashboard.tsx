...
import { Bell, TrendingUp, Users, MessageSquare } from 'lucide-react';
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            <p className="text-sm text-muted-foreground">
              Use the sidebar to navigate to different sections of your social media management dashboard.
            </p>
