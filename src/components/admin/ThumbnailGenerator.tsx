...
const ThumbnailGenerator = ({ 
  ...
  const generateThumbnail = async () => {
    ...
    try {
      ...
      const thumbnailPrompt = `Create a professional blog thumbnail image for "${blogTitle}". 
        Category: ${blogCategory}. 
        Context: ${blogExcerpt}. 
        Style: Modern, clean, eye-catching thumbnail with text overlay space, professional design, high contrast, readable at small sizes.
        Dimensions: 1920x1080 aspect ratio.`;
